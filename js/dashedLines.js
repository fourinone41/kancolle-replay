...
var DashLine = /** @class */ (function () {
    ...
    DashLine.prototype.setLineStyle = function () {
        ...
        if (this.useTexture) {
            ...
            this.graphics.lineStyle(options.width * options.scale, options.color, options.alpha)
        }
    ...
    DashLine.prototype.lineTo = function (x, y, closePath, offsetStart, offsetEnd, endWithArrow) {
