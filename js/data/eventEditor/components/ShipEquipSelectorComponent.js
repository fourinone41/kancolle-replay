...
var METHODS_COMMON = {
	...
	methods: {
		doClose: function() {
			...
			if (METHODS_COMMON.callbackClose) METHODS_COMMON.callbackClose();
		},
		doSubmit: function(mstId) {
			if (METHODS_COMMON.callbackSubmit) METHODS_COMMON.callbackSubmit(+mstId);
			this.doClose();
		},
...
let UI_SHIPSELECTOR = window.ShipSelectorComponent = {
	data: () => ({
		active: false,
		searchName: '',
		searchResults: [],
	...
	mounted: function() {
		COMMON.global.shipSelector = this;
	},
	methods: {
		open: function(callbackSubmit,callbackClose,keyInit) {
...
let UI_EQUIPSELECTOR = window.EquipSelectorComponent = {
	data: () => ({
		active: false,
		searchName: '',
		searchResults: [],
	...
	mounted: function() {
		COMMON.global.equipSelector = this;
	},
	methods: {
		open: function(callbackSubmit,callbackClose,keyInit) {
			METHODS_COMMON.callbackSubmit = callbackSubmit;
